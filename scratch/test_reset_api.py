...
def start_server():
    print("[Server] Booting server on port 54321...")
...
def run_test():
    ...
    try:
        status, body = http_post("http://127.0.0.1:54321/api/login", {"username": "", "password": ""})
    ...
    # Let's find a world to reset
    headers = {"Authorization": f"Bearer {token}"}
    print("[Client] Listing worlds...")
