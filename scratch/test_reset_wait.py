...
def run_test():
    ...
    def fetch_world():
        ...
        try:
            ...
            print(f"[Client Thread 1] /api/world Response: {status}")
    ...
    def fetch_currencies():
        ...
        try:
            ...
            print(f"[Client Thread 2] /api/worlds/.../currencies Response: {status}")
        except Exception as e:
    ...
    t1.join()
    t2.join()
    print("[Client] Completed entrance fetches. Now sleeping for 15 seconds to observe background pre-generation...")
